...
function ProfilePage({
  ...
  const DISPLAY_USER_IMAGE = authReducer?.userData?.profile_img?.name;
          ...
          <div className="row">
            <div className="col-lg-8">
              <div className="user-record">
                <img
                  src={
                    DISPLAY_USER_IMAGE !== undefined
                      ? `${baseUrl}/public/${authReducer?.userData?.profile_img?.name}`
                      : USER_IMG
                  }
                  alt="user-image"
                />
                ...
                <div className="user-edit">
                  ...
                  <div className="email-record">
                    ...
                    <p>{`ID: ${authReducer?.userData?._id}`}</p>
                  </div>
                </div>
              </div>
            </div>
                  ...
                  <div className="row feature-border">
                    ...
                    <div className="col-lg-8">
                      <div className="feature">
                        ...
                        <p>
                          Checking this box will all ads from the website for
                          you <br />
                          YOU MUST BE A CS PLUS MEMBER TO ENABLE THIS FEATURE
                        </p>
                      </div>
